#!/usr/bin/env python
"""
Package metadata for aspects_superset_aside.
"""
import os
import re
import sys
...
VERSION = get_version('aspects_superset_aside', '__init__.py')
...
setup(
    name='aspects-superset-aside',
    version=VERSION,
    description="""One-line description for README and other doc files.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/aspects-superset-aside',
    packages=find_packages(
        include=['aspects_superset_aside', 'aspects_superset_aside.*'],
        exclude=["*tests"],
    ),
