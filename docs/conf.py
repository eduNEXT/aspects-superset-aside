...
"""
aspects-superset-aside documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'aspects-superset-aside',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/aspects-superset-aside",
...
#
# html_title = 'aspects-superset-aside v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'aspects_superset_aside'),
                os.path.join(root_path, 'aspects_superset_aside/migrations')])
