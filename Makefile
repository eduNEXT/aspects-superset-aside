...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd aspects_superset_aside && ../manage.py makemessages -l en -v1 -d django
	cd aspects_superset_aside && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd aspects_superset_aside && ../manage.py compilemessages

detect_changed_source_translations:
	cd aspects_superset_aside && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd aspects_superset_aside && i18n_tool dummy
